    ...
    <table>
        <table>
            ...
            <tbody>
                ...
                @if (count($user_letters))
                    @foreach ($user_letters as $index => $user_letter)
                        @php
                        ...
                        <tr class="table_row">
                            ...
                            <td> {{ format_date($user_letter->issue_date) }} </td>
                            <td> {{ $user_letter->status }} </td>
