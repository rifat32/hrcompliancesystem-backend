    ...
    public function defaultDataSetupForBusiness($businesses)
    {
        ...
        foreach ($businesses as $business) {
            ...
            foreach ($this->defaultModels as $model) {
                ...
                // Skip Bank::class if the business is not in the UK

                if ((empty($business->enable_auto_business_setup) && $model !== Bank::class) ||
                ($model === Bank::class && $business->country !== 'United Kingdom')) {
                continue;
            }
