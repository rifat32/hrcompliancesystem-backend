        ...
        try {
            ...
            ->where(function($query) use($all_manager_department_ids) {
               ...
               ;
                  ...
                  $announcements =  $this->retrieveData($announcementsQuery, "id", "announcements");
     ...
     */
     ...
     public function getAnnouncementsClient(Request $request)
     {
         try {
             ...
             $all_parent_departments_of_user = $this->departmentComponent->all_parent_departments_of_user(auth()->user()->id);
     ...
     public function getAnnouncementsCountClient(Request $request)
     {
         try {
             ...
             ->whereHas("users", function($query) use($request) {
                ...
                $announcements =  $this->retrieveData($announcementsQuery, "id", "announcements")->count();
