...
class AuthRegisterBusinessRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        $rules = [
            ...
            'business.delete_read_notifications_after_30_days' => 'required|boolean',
            'business.business_start_day' => 'required|numeric',


            'business.pin_code' => 'nullable|string',

            'business.enable_auto_business_setup' => 'required|boolean',
        ...
        if(auth()->user()) {
            $rules['business.trail_end_date'] = 'required|date';
        }
