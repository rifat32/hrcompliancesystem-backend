...
class VerifyMail extends Mailable
{
    ...
    public function build()
    {
        ...
        $html_content =  str_replace("[Title]", $this->user->title, $html_content );
        ...
        $html_content =  str_replace("[FullName]", ($this->user->title . " " .$this->user->first_Name . " " . $this->user->middle_Name . " " .$this->user->last_Name), $html_content );
