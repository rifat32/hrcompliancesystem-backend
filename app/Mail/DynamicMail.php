...
class DynamicMail extends Mailable
{
   ...
   private $type;
    ...
    public function build()
    {
        ...
        $html_content =  str_replace("[customer_Title]", $this->data->customer->title, $html_content );
        ...
        $html_content =  str_replace("[customer_FullName]", ($this->data->customer->title . " " . $this->data->customer->first_Name. " " .$this->data->customer->last_Name), $html_content );


$html_content =  str_replace("[business_owner_Title]", $this->data->business->owner->title, $html_content );
        ...
        $html_content =  str_replace("[business_owner_FullName]", ($this->data->business->owner->title. " " .$this->data->business->owner->first_Name. " " .$this->data->business->owner->last_Name), $html_content );
